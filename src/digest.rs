...
impl Checksum {
    ...
    pub fn digest<P: AsRef<Path>, T: AsRef<[u8]>>(
...
mod tests {
    ...
    fn verify_blake2() {
        assert_eq!(
            ...
            [
                ...
                0xf2, 0xec, 0xe4, 0xc1, 0x48, 0x09, 0x5c, 0x5f, 0xaa, 0x73, 0xe2, 0x4b, 0x4c, 0xc5,
                0xd6, 0x66, 0xc3, 0xe4, 0x5e, 0xc2, 0x71, 0x50, 0x4e, 0x14, 0xdc, 0x61, 0x27, 0xdd,
                0xfc, 0xe4, 0xe1, 0x44, 0xfb, 0x23, 0xb9, 0x1a, 0x6f, 0x7b, 0x04, 0xb5, 0x3d, 0x69,
                0x55, 0x02, 0x29, 0x07, 0x22, 0x95, 0x3b, 0x0f
            ]
        );
        assert_eq!(
            Checksum::digest(HashAlgorithm::Blake2s, &("-", b"Hello, world!")).digest,
            [
                0x30, 0xd8, 0x77, 0x7f, 0x0e, 0x17, 0x85, 0x82, 0xec, 0x8c, 0xd2, 0xfc, 0xdc, 0x18,
    ...
    fn verify_blake3() {
        assert_eq!(
            ...
            [
                0xed, 0xe5, 0xc0, 0xb1, 0x0f, 0x2e, 0xc4, 0x97, 0x9c, 0x69, 0xb5, 0x2f, 0x61, 0xe4,
                0x2f, 0xf5, 0xb4, 0x13, 0x51, 0x9c, 0xe0, 0x9b, 0xe0, 0xf1, 0x4d, 0x09, 0x8d, 0xcf,
                0xe5, 0xf6, 0xf9, 0x8d
            ]
        );
    }
    ...
    fn verify_fsb() {
        ...
        assert_eq!(
            ...
            [
                0x42, 0x18, 0xc2, 0x45, 0xdf, 0xc0, 0x96, 0x47, 0x03, 0xb5, 0x0f, 0xaa, 0x57, 0xf6,
                0xc1, 0x3f, 0xf3, 0xf1, 0x18, 0x96, 0xc4, 0x9b, 0x95, 0x64, 0x0f, 0x78, 0xc7, 0xb2
            ]
        );
        assert_eq!(
            Checksum::digest(HashAlgorithm::Fsb256, &("-", b"Hello, world!")).digest,
            [
                0xb7, 0x5c, 0x25, 0x0c, 0x35, 0xcc, 0xeb, 0xeb, 0x67, 0xd6, 0xe9, 0xa5, 0x17, 0x3e,
                0x63, 0x8a, 0x0e, 0xbc, 0x25, 0x45, 0x67, 0x4c, 0x2d, 0xa1, 0x7f, 0xc0, 0x27, 0x5a,
                0x62, 0xb3, 0xf6, 0x9c
            ]
        );
        assert_eq!(
            ...
            [
                0x95, 0xe4, 0xb3, 0x23, 0x81, 0x05, 0x75, 0x4d, 0x1c, 0x54, 0xdc, 0xc6, 0xfa, 0xb0,
        ...
        assert_eq!(
            ...
            [
                ...
                0x23, 0x32, 0x94, 0x07, 0x1c, 0xa9, 0x15, 0xe5, 0x68, 0x87, 0x54, 0x94, 0x64, 0xdc,
                0x7d, 0x3e, 0x07, 0x7f, 0x08, 0x49, 0x2e, 0x6e, 0xd0, 0xd3, 0x82, 0x94, 0x3e, 0xfb,
                0xea, 0xb2, 0x0e, 0x19, 0x1a, 0x5f, 0x09, 0xd0
            ]
        );
    }
    ...
    fn verify_gost() {
        assert_eq!(
            ...
            [
                0x71, 0x1e, 0x00, 0xe0, 0x34, 0xa9, 0x25, 0x47, 0x65, 0xf6, 0x27, 0x0b, 0xd0, 0x2b,
        ...
        assert_eq!(
            ...
            [
                0xc0, 0x03, 0xab, 0xf7, 0xee, 0x48, 0xc4, 0x2f, 0xe2, 0x3c, 0xad, 0x86, 0xd5, 0x6d,
                0x2c, 0x98, 0x24, 0x61, 0xf9, 0x4d, 0x46, 0xb1, 0x09, 0xa9, 0xf6, 0xb2, 0xe9, 0x60,
                0xf5, 0x83, 0xcf, 0x52
            ]
        );
    }
    ...
    fn verify_groestl() {
        assert_eq!(
            ...
            [
                ...
                0x3d, 0x73, 0xa3, 0xa5, 0x1c, 0xd6, 0x92, 0x7c, 0xdc, 0x1b, 0x7f, 0xf5, 0xe2, 0x0a
            ]
        );
        assert_eq!(
            ...
            [
                ...
                0x9e, 0x03, 0x89, 0x26, 0xaf, 0x83, 0x9c, 0x86, 0xea, 0xf9, 0x65, 0x53, 0x02, 0x7d,
                0x2c, 0x85, 0x1e, 0x18
            ]
        );
        assert_eq!(
            ...
            [
                ...
                0x21, 0xff, 0x18, 0x45, 0x4e, 0x45, 0x1f, 0x82, 0x94, 0x98, 0xcc, 0x0d, 0x76, 0x01,
                0x8c, 0x11, 0xf9, 0xf1, 0x38, 0x36, 0x54, 0x5f, 0x5d, 0x61, 0xac, 0x32, 0x09, 0xa2,
        ...
        assert_eq!(
            ...
            [
                0xb6, 0x06, 0x58, 0xe7, 0x23, 0xa8, 0xeb, 0x17, 0x43, 0x82, 0x3a, 0x80, 0x02, 0x17,
                0x54, 0x86, 0xbc, 0x24, 0x22, 0x3b, 0xa3, 0xdc, 0x6d, 0x8c, 0xb4, 0x35, 0xa9, 0x48,
                0xf6, 0xd2, 0xb9, 0x74, 0x4a, 0xc9, 0xe3, 0x07, 0xe1, 0xd3, 0x80, 0x21, 0xea, 0x18,
                0xc4, 0xd5, 0x36, 0xd2, 0x8f, 0xc2, 0x34, 0x91, 0xd7, 0x77, 0x1a, 0x5a, 0x5b, 0x0d,
                0x02, 0xff, 0xad, 0x9a, 0x07, 0x3d, 0xcc, 0x28
            ]
        );
    }
    ...
    fn verify_keccak() {
        ...
        assert_eq!(
            ...
            [
                ...
                0xc3, 0x17, 0xf3, 0x43, 0x0f, 0xda, 0x3d, 0xbe, 0xb4, 0x40, 0x10, 0x84, 0x4b, 0x35,
                0xbc, 0xcc, 0x8e, 0x19, 0x00, 0x61, 0xd0, 0x5b, 0x4d, 0x00, 0x2c, 0x70, 0x96, 0x15,
                0x27, 0x5a, 0x44, 0xe1, 0x8e, 0x49, 0x4f, 0x0c
            ]
        );
    }
    ...
    fn verify_md2() {
        assert_eq!(
            ...
            [
                0x8c, 0xca, 0x0e, 0x96, 0x5e, 0xdd, 0x0e, 0x22, 0x3b, 0x74, 0x4f, 0x9c, 0xed, 0xf8,
                0xe1, 0x41
            ]
        );
    }
    ...
    fn verify_md4() {
        assert_eq!(
            ...
            [
                0x0a, 0xbe, 0x9e, 0xe1, 0xf3, 0x76, 0xca, 0xa1, 0xbc, 0xec, 0xad, 0x90, 0x42, 0xf1,
                0x6e, 0x73
            ]
        );
    }
    ...
    fn verify_md5() {
        assert_eq!(
            ...
            [
                0x6c, 0xd3, 0x55, 0x6d, 0xeb, 0x0d, 0xa5, 0x4b, 0xca, 0x06, 0x0b, 0x4c, 0x39, 0x47,
                0x98, 0x39
            ]
        );
    }
    ...
    fn verify_ripemd() {
        ...
        assert_eq!(
            ...
            [
                ...
                0x19, 0x57, 0x07, 0x4a, 0x9f, 0xd3, 0xf5, 0x97, 0xcd, 0xa5, 0xc9, 0x02, 0x35, 0xa6,
                0xa8, 0x50, 0x61, 0xe5
            ]
        );
        assert_eq!(
            ...
            [
                ...
                0xff, 0x12, 0xcf, 0xee, 0x2a, 0x97, 0x04, 0xcd, 0xf9, 0xc2, 0xe7, 0xd0, 0xfe, 0x03,
                0x99, 0xcf, 0x6e, 0xe6, 0x6a, 0x71, 0xba, 0xbb, 0x49, 0xf5, 0x87, 0x0d
            ]
        );
    }
    ...
    fn verify_sha2() {
        assert_eq!(
            ...
            [
                ...
                0x80, 0x91, 0x29, 0x07, 0x64, 0xb7, 0xf2, 0xa6, 0x4f, 0xe6, 0xe7, 0x8e, 0x95, 0x68
            ]
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            [
                0x55, 0xbc, 0x55, 0x6b, 0x0d, 0x2f, 0xe0, 0xfc, 0xe5, 0x82, 0xba, 0x5f, 0xe0, 0x7b,
                0xaa, 0xff, 0xf0, 0x35, 0x65, 0x36, 0x38, 0xc7, 0xac, 0x0d, 0x54, 0x94, 0xc2, 0xa6,
                0x4c, 0x0b, 0xea, 0x1c, 0xc5, 0x73, 0x31, 0xc7, 0xc1, 0x2a, 0x45, 0xcd, 0xbc, 0xa7,
                0xf4, 0xc3, 0x4a, 0x08, 0x9e, 0xeb
            ]
        );
        assert_eq!(
            Checksum::digest(HashAlgorithm::Sha512, &("-", b"Hello, world!")).digest,
            [
                0xc1, 0x52, 0x7c, 0xd8, 0x93, 0xc1, 0x24, 0x77, 0x3d, 0x81, 0x19, 0x11, 0x97, 0x0c,
                0x8f, 0xe6, 0xe8, 0x57, 0xd6, 0xdf, 0x5d, 0xc9, 0x22, 0x6b, 0xd8, 0xa1, 0x60, 0x61,
                0x4c, 0x0c, 0xd9, 0x63, 0xa4, 0xdd, 0xea, 0x2b, 0x94, 0xbb, 0x7d, 0x36, 0x02, 0x1e,
                0xf9, 0xd8, 0x65, 0xd5, 0xce, 0xa2, 0x94, 0xa8, 0x2d, 0xd4, 0x9a, 0x0b, 0xb2, 0x69,
    ...
    fn verify_sha3() {
        assert_eq!(
            ...
            [
                ...
                0x7b, 0x75, 0x92, 0x52, 0xad, 0x56, 0xc0, 0x5a, 0x1b, 0x0a, 0xcc, 0x31, 0xdc, 0x69
            ]
        );
        assert_eq!(
            Checksum::digest(HashAlgorithm::Sha3_256, &("-", b"Hello, world!")).digest,
            [
                0xf3, 0x45, 0xa2, 0x19, 0xda, 0x00, 0x5e, 0xbe, 0x9c, 0x1a, 0x1e, 0xaa, 0xd9, 0x7b,
                0xbf, 0x38, 0xa1, 0x0c, 0x84, 0x73, 0xe4, 0x1d, 0x0a, 0xf7, 0xfb, 0x61, 0x7c, 0xaa,
                0x0c, 0x6a, 0xa7, 0x22
            ]
        );
        assert_eq!(
            ...
            [
                ...
                0x83, 0xa4, 0x59, 0x01, 0xfd, 0x1a, 0x27, 0x28, 0x9d, 0x72, 0xfc, 0x0e, 0x3f, 0xf4,
        ...
        assert_eq!(
            ...
            [
                0x8e, 0x47, 0xf1, 0x18, 0x5f, 0xfd, 0x01, 0x4d, 0x23, 0x8f, 0xab, 0xd0, 0x2a, 0x1a,
                0x32, 0xde, 0xfe, 0x69, 0x8c, 0xbf, 0x38, 0xc0, 0x37, 0xa9, 0x0e, 0x3c, 0x0a, 0x0a,
                0x32, 0x37, 0x0f, 0xb5, 0x2c, 0xbd, 0x64, 0x12, 0x50, 0x50, 0x85, 0x02, 0x29, 0x5f,
                0xca, 0xbc, 0xbf, 0x67, 0x6c, 0x09, 0x47, 0x0b, 0x27, 0x44, 0x38, 0x68, 0xc8, 0xe5,
                0xf7, 0x0e, 0x26, 0xdc, 0x33, 0x72, 0x88, 0xaf
            ]
        );
    }
    ...
    fn verify_shabal() {
        assert_eq!(
            ...
            [
                0x55, 0x30, 0xac, 0xe9, 0xc4, 0xf7, 0x25, 0x42, 0xda, 0x20, 0x0b, 0x10, 0x9f, 0x2f,
        ...
        assert_eq!(
            ...
            [
                0x64, 0xe0, 0x6c, 0xbe, 0x06, 0xf9, 0x82, 0x27, 0x31, 0xbd, 0xd2, 0xa2, 0xcc, 0x8e,
                0x01, 0x63, 0x72, 0x02, 0xe2, 0xec, 0xd3, 0xef, 0x6b, 0x33, 0x60, 0xb8, 0x73, 0xb5
            ]
        );
        assert_eq!(
            Checksum::digest(HashAlgorithm::Shabal256, &("-", b"Hello, world!")).digest,
            [
                0xe5, 0x8d, 0x8d, 0x76, 0x4a, 0xd4, 0xdb, 0x5e, 0x71, 0x6d, 0xf1, 0x84, 0x02, 0x83,
        ...
        assert_eq!(
            ...
            [
                ...
                0x7e, 0xe9, 0x10, 0x21, 0x69, 0xf4, 0x43, 0x56, 0x0a, 0x72, 0xe5, 0x53, 0xfb, 0x65,
        ...
        assert_eq!(
            ...
            [
                0x70, 0x48, 0xf0, 0xa5, 0x89, 0x33, 0x9d, 0x2d, 0x26, 0x89, 0x07, 0x01, 0xed, 0x3b,
                ...
                0xdb, 0x3b, 0x18, 0xa7, 0x65, 0x2e, 0x04, 0x12, 0x34, 0x8e, 0xbf, 0xd6, 0x1d, 0x32,
                0xd7, 0x55, 0xd6, 0x09, 0x8b, 0xff, 0x8c, 0xb3
            ]
        );
    }
    ...
    fn verify_sm3() {
        assert_eq!(
            ...
            [
                0xe3, 0xbc, 0xa1, 0x01, 0xb4, 0x96, 0x88, 0x0c, 0x36, 0x53, 0xda, 0xd8, 0x58, 0x61,
                0xd0, 0xe7, 0x84, 0xb0, 0x0a, 0x8c, 0x18, 0xf7, 0x57, 0x44, 0x72, 0xd1, 0x56, 0x06,
                0x0e, 0x90, 0x96, 0xbf
            ]
        );
    }
    ...
    fn verify_streebog() {
        assert_eq!(
            ...
            [
                ...
                0x71, 0x8f, 0x6f, 0x6e, 0x41, 0x2d, 0xb8, 0x61, 0x1a, 0x38, 0x02, 0x5c, 0x51, 0x0a,
                0xc8, 0xf8, 0x5a, 0xeb
            ]
        );
        assert_eq!(
            ...
            [
                0xa8, 0x33, 0x52, 0xd3, 0x5d, 0xc8, 0xf0, 0x7c, 0xa8, 0x04, 0x8e, 0x67, 0x52, 0x41,
                ...
                0xed, 0x01, 0x61, 0x28, 0x39, 0x1c, 0x31, 0x2d, 0xfe, 0x3a, 0x00, 0xe0, 0xa9, 0xbd,
                0x0e, 0x49, 0x73, 0x89, 0xc8, 0x88, 0xee, 0xdc
            ]
        );
    }
    ...
    fn verify_whirlpool() {
        assert_eq!(
            ...
            [
                ...
                0x00, 0xcc, 0xac, 0xa0, 0xc3, 0x4d, 0x58, 0xc6, 0x98, 0x8e, 0x44, 0xf4, 0x54, 0x89,
                0xcf, 0xb1, 0x6b, 0xeb, 0x4b, 0x6b, 0xf0, 0xce, 0x20, 0xbe, 0x1d, 0xb2, 0x2a, 0x10,
                0xb0, 0xe4, 0xbb, 0x68, 0x04, 0x80, 0xa3, 0xd2, 0x42, 0x9e, 0x6c, 0x48, 0x30, 0x85,
                0x45, 0x3c, 0x09, 0x8b, 0x65, 0x85, 0x24, 0x95
            ]
        );
    }
}
